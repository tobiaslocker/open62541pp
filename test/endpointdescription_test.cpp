...
BOOST_AUTO_TEST_CASE(test_endpoint_description) {
  ...
  //  BOOST_TEST_MESSAGE("Endpoint url: " +
  //  parser::from_open62541(ua_desc.endpointUrl)); auto desc =
  //  parser::from_open62541(ua_desc); auto test_tokens =
  //  std::vector<UserTokenPolicy>(); UA_UserTokenPolicy policy1;
  //  test_tokens.push_back(parser::from_open62541(policy1));
  //  auto a =
  //  parser::from_open62541(common::make_ua_application_description());
...
BOOST_AUTO_TEST_CASE(test_another_test) { BOOST_TEST(true); }
